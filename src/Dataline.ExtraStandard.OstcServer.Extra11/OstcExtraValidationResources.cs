...
namespace ExtraStandard.OstcServer.Extra11
{
    /// <summary>
    /// Implementation von <see cref="IExtraValidationResources"/> für eXTra 1.1-Dokumente
    /// </summary>
    public class OstcExtraValidationResources : IExtraValidationResources
    {
        /// <summary>
        /// Initialisiert eine neue Instanz der <see cref="OstcExtraValidationResources"/> Klasse.
        /// </summary>
        ...
        public OstcExtraValidationResources(ExtraMessageType messageType, ExtraTransportDirection transportDirection, bool isError)
        {
            var type = GetType();
#if HAS_FULL_TYPE
